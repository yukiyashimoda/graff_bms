...
export function IssuerEditModal({ profile }: { profile: IssuerProfile }) {
        ...
        >
          ...
          >
            ...
            <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
              ...
              {/* ロゴ */}
              <div>
                <p className="text-xs font-semibold mb-2" style={{ color: 'var(--text-secondary)' }}>会社ロゴ</p>
                {logoPreview ? (
  ...
  return (
    <div>
      <p className="text-xs font-semibold mb-1.5" style={{ color: 'var(--text-secondary)' }}>
        {label}{required && <span style={{ color: '#d84f2a' }}> *</span>}
      </p>
      {children}
    </div>
  )
